    ...
    export default{
        ...
        methods:{
            ...
            init(){
                ...
                //this.liw = (Math.ceil(box.clientWidth/this.cresults.length)-1)*1.5;
                ...
                .imgWrap
                    ...
                    li
                        ...
                        img
                           display:block;       
        .add-source-btn
            width:105px;height:108px;position:absolute;top:50%;left:50%;margin-top:-54px;margin-left:-48px;bgImg('~common/images/worktime/addBtn2_2.png');background-size:contain;cursor:pointer;
            .addSucaiText
              color:#63b375;width:100%;text-align:center;font-size:12px;letter-spacing:1px;position:absolute;bottom:3px; 
               
    .add-file-box
        wh(510px,200px);bgImg('~common/images/worktime/noworktime.jpg');margin: 0 auto;position:relative;top:94px;
