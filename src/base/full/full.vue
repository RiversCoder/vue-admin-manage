                    ...
                    <div class="add-file-box">
                        <div class="add-source-wrap">
                            <ul class="imgWrap" ref="imgWrap">
                                <li v-for="(item,index) in cresults" :width="liw-1+'px'" :height="Math.floor((liw-1)*0.56)+'px'" >
                                    <img :src="item.img" alt="" :width="(liw-1)+'px'"  :height="Math.floor((liw-1)*0.56)+'px'" >
                                </li>
                            </ul>
    ...
    export default{
        ...
        methods:{
            ...
            init(){
                ...
                //this.liw = (Math.ceil(box.clientWidth/this.cresults.length)-1)*2;
...
<style scoped lang="stylus" rel="stylesheet/stylus">
    ...
    .timebox
        ...
        .tb_wrap
            ...
            .add-source-wrap
                wh(100%,200px);position:absolute;bottom:0;left:0;overflow:hidden; 
                .imgWrap
                    ...
                    li
                        ...
                        img
                           display:block;       
        .add-source-btn
            width:120px;height:112px;position:absolute;left:50%;margin-left:-52px;top:50%;margin-top:-61px;bgImg('~common/images/worktime/addBtn4.png');background-size:contain;background-position:center center;cursor:pointer;
          .addSucaiText
              color:#f58e1f;width:100%;text-align:center;font-size:12px;letter-spacing:1px;position:absolute;bottom:3px;  
               
    .add-file-box
        wh(510px,200px);bgImg('~common/images/worktime/fullscreen.jpg');margin: 0 auto;position:relative;top:94px;
